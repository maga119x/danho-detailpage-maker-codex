...
## Typography
Paperlogy 패밀리 단일 사용. 본문 32px(`body-md`)을 기준으로, 섹션 제목은 46~68px(`h2`), 메인 헤드라인은 56~84px(`h1`), 최상단 짧은 디스플레이만 64~96px. 굵기는 500(본문)/700(소제목)/800(헤드라인) 세 단계.
...
## Shapes
라운드 12~16px 기본. 카드/배지는 단정한 모서리. 상세페이지 마감에는 버튼형 CTA를 만들지 않음.
